class MailJobSchedule < ApplicationRecord
  ...
  enum sync_status: { not_synced: 0, syncing: 1, synced: 2, failed: 3 }
  ...
  def new_or_specific_column_changed?
    (saved_change_to_sync_status? || saved_change_to_last_sync_email_count? || saved_change_to_sync_status? || saved_change_to_last_sync_email_count? || saved_change_to_message?)
  end
